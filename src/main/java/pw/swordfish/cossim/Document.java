...
class Document implements Comparable<Document> {
    ...
    private final HashMultiSet<String> documentHashMultiSet;
    ...
    public float getCosineSimilarity() {
        ...
        if (!isCosineSimilaritySet)
            throw new IllegalStateException("The cosine similarity has not been set");
     ...
     */
    float r(String term, int numberOfDocuments) {
